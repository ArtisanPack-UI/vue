...
/**
 * @module InertiaCheckbox
 *
 * Wraps the ArtisanPack UI Checkbox component with automatic Inertia validation
 * error binding.
 */
import { computed, inject } from 'vue';
import { usePage } from '@inertiajs/vue3';
import { Checkbox } from '@artisanpack-ui/vue';
...
<template>
  <Checkbox v-bind="{ ...$attrs, name, error: resolvedError }" v-model="model" />
</template>
