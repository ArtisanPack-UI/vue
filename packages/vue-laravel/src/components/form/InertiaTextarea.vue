...
/**
 * @module InertiaTextarea
 *
 * Wraps the ArtisanPack UI Textarea component with automatic Inertia validation
 * error binding.
 */
import { computed, inject } from 'vue';
import { usePage } from '@inertiajs/vue3';
import { Textarea } from '@artisanpack-ui/vue';
...
<template>
  <Textarea v-bind="{ ...$attrs, name, error: resolvedError }" v-model="model" />
</template>
